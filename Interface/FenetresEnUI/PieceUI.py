...
"")
        ...
        self.label_4 = QtWidgets.QLabel(Piece)
        font = QtGui.QFont()
        ...
        self.gridLayout.addWidget(self.listViewPieceCategorie, 8, 0, 1, 2)
...
"}")
        ...
        self.gridLayout.addWidget(self.labelCategorieSelectionnee, 7, 0, 1, 1)
...
"")
        ...
        self.gridLayout.addWidget(self.comboBoxCategorieSelectionnee, 7, 1, 1, 1)
...
"}")
    ...
    def retranslateUi(self, Piece):
        ...
        self.label_4.setText(_translate("Piece", "Résumé des pièces pour chaque catégorie"))
        ...
        self.label_2.setText(_translate("Piece", "Sélectionner la catégorie de la pièce"))

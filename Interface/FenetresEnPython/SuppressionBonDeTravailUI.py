...
"    ")
    ...
    def retranslateUi(self, SuppressionBonDeTravail):
        ...
        self.comboBoxNomTech.setItemText(0, _translate("SuppressionBonDeTravail", "Gary"))
        self.comboBoxNomTech.setItemText(1, _translate("SuppressionBonDeTravail", "Sony"))
        self.comboBoxNomTech.setItemText(2, _translate("SuppressionBonDeTravail", "Jean-Michel"))

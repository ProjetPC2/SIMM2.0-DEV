...
class Ui_SuppressionBonDeTravail(object):
    def setupUi(self, SuppressionBonDeTravail):
        ...
        SuppressionBonDeTravail.resize(915, 803)
...
"")
        ...
        self.comboBoxNomTech.setMaximumSize(QtCore.QSize(200, 16777215))
        font = QtGui.QFont()
        font.setPointSize(10)
...
"}")
        ...
        self.comboBoxOuvertFerme.setMaximumSize(QtCore.QSize(800, 16777215))
        font = QtGui.QFont()
        font.setPointSize(10)

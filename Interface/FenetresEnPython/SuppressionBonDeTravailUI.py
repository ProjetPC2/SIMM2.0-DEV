...
"")
        ...
        self.comboBoxNomTech.setMaximumSize(QtCore.QSize(223, 16777215))
        font = QtGui.QFont()
        font.setPointSize(10)
...
"    ")
        ...
        self.dateEdit.setMaximumSize(QtCore.QSize(102, 16777215))
        font = QtGui.QFont()
        font.setPointSize(10)
...
"}")
        ...
        self.comboBoxOuvertFerme.setMaximumSize(QtCore.QSize(78, 16777215))
        font = QtGui.QFont()
        font.setPointSize(10)
...
"    ")
    ...
    def retranslateUi(self, SuppressionBonDeTravail):
        ...
        self.comboBoxNomTech.setItemText(0, _translate("SuppressionBonDeTravail", "Evens"))
        self.comboBoxNomTech.setItemText(1, _translate("SuppressionBonDeTravail", "Gimps"))
        self.comboBoxNomTech.setItemText(2, _translate("SuppressionBonDeTravail", "Dorciné"))
        self.comboBoxNomTech.setItemText(3, _translate("SuppressionBonDeTravail", "Alix"))

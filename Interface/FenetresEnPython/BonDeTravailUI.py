...
class Ui_BonDeTravail(object):
    def setupUi(self, BonDeTravail):
        ...
        BonDeTravail.resize(1376, 1376)
        BonDeTravail.setStyleSheet("QMainWindow \n"
" {\n"
"\n"
"background: white;\n"
"}\n"
...
"background:rgb(247,247,247)\n"
"}")
        self.gridLayout = QtWidgets.QGridLayout(BonDeTravail)
        ...
        spacerItem1 = QtWidgets.QSpacerItem(290, 20, QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Minimum)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../../../../PC2/SIMM2.0-DEV/Interface/Images/actualize-arrows-couple-in-circle.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"")
        ...
        self.labelPhotoPlus.setPixmap(QtGui.QPixmap("../../../../PC2/SIMM2.0-DEV/Interface/Images/plus.png"))
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("../../../../PC2/SIMM2.0-DEV/Interface/Images/plus_64.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("../../../../PC2/SIMM2.0-DEV/Interface/Images/save (1).png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("../../../../PC2/SIMM2.0-DEV/Interface/Images/double-left-chevron.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("../../../../PC2/SIMM2.0-DEV/Interface/Images/angle-pointing-to-left (1).png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("../../../../PC2/SIMM2.0-DEV/Interface/Images/angle-arrow-pointing-to-right.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("../../../../PC2/SIMM2.0-DEV/Interface/Images/double-angle-pointing-to-right.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        spacerItem5 = QtWidgets.QSpacerItem(220, 13, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
...
"}")
        ...
        spacerItem7 = QtWidgets.QSpacerItem(43, 20, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        ...
        spacerItem8 = QtWidgets.QSpacerItem(30, 30, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Maximum)
        ...
        spacerItem9 = QtWidgets.QSpacerItem(40, 45, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        ...
        spacerItem10 = QtWidgets.QSpacerItem(50, 45, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Maximum)

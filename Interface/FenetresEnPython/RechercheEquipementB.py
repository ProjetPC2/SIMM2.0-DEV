...
class RechercheEquipementUI(object):
    def setupUi(self, Form):
        ...
        self.lineEditNumeroSerie = QtWidgets.QLineEdit(Form)
        self.lineEditNumeroSerie.setMaximumSize(QtCore.QSize(200, 25))
        font = QtGui.QFont()
        font.setFamily("MS Shell Dlg 2")
...
"background:rgb(247, 247, 247)")
        ...
        self.gridLayout_3.addWidget(self.lineEditNumeroSerie, 1, 1, 1, 1, QtCore.Qt.AlignLeft)
...
"background:rgb(247, 247, 247)")
        ...
        self.labelCategorieEquipement = QtWidgets.QLabel(Form)
        font = QtGui.QFont()
        font.setFamily("MS Shell Dlg 2")
        font.setPointSize(10)
        self.labelCategorieEquipement.setFont(font)
        self.labelCategorieEquipement.setObjectName("labelCategorieEquipement")
        self.gridLayout_3.addWidget(self.labelCategorieEquipement, 0, 0, 1, 1)
        self.labelNumeroSerie = QtWidgets.QLabel(Form)
        self.labelNumeroSerie.setMaximumSize(QtCore.QSize(16777215, 40))
        font = QtGui.QFont()
        font.setFamily("MS Shell Dlg 2")
        font.setPointSize(10)
        self.labelNumeroSerie.setFont(font)
        self.labelNumeroSerie.setObjectName("labelNumeroSerie")
        self.gridLayout_3.addWidget(self.labelNumeroSerie, 0, 1, 1, 1)
...
"background:rgb(247, 247, 247)")
    ...
    def retranslateUi(self, Form):
        ...
        self.labelCategorieEquipement.setText(_translate("Form", "Catégorie d\'équipement"))
        self.labelNumeroSerie.setText(_translate("Form", "Numéro de série"))

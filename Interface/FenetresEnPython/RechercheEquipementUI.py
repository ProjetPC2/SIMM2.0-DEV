...
class Ui_RechercheEquipement(object):
    def setupUi(self, RechercheEquipement):
        ...
        RechercheEquipement.resize(824, 506)
        RechercheEquipement.setStyleSheet("background: white;")
        self.gridLayout_4 = QtWidgets.QGridLayout(RechercheEquipement)
...
"background:rgb(247,247,247);")
        ...
        spacerItem6 = QtWidgets.QSpacerItem(230, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)

...
class Ui_RechercheEquipement(object):
    def setupUi(self, RechercheEquipement):
        ...
        RechercheEquipement.resize(1353, 810)
...
"background:rgb(247,247,247);")
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("SIMM/SIMM2.0-DEV/Interface/FenetresEnUI/Images/Refresh2.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.logoLoupe.setPixmap(QtGui.QPixmap("SIMM/SIMM2.0-DEV/Interface/FenetresEnUI/Images/magnifier.png"))

...
"}")
    ...
    def retranslateUi(self, BonDeTravail):
        ...
        self.comboBoxNomTech.setItemText(1, _translate("BonDeTravail", "Alix"))
        self.comboBoxNomTech.setItemText(2, _translate("BonDeTravail", "Gimps"))
        self.comboBoxNomTech.setItemText(3, _translate("BonDeTravail", "Dorciné"))

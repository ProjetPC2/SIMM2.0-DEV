...
"}")
    ...
    def retranslateUi(self, BonDeTravail):
        ...
        self.comboBoxNomTech.setItemText(0, _translate("BonDeTravail", "Evens"))
        self.comboBoxNomTech.setItemText(1, _translate("BonDeTravail", "Gimps"))
        self.comboBoxNomTech.setItemText(2, _translate("BonDeTravail", "Dorciné"))
        self.comboBoxNomTech.setItemText(3, _translate("BonDeTravail", "Alix"))
        ...
        self.checkBoxPiece.setText(_translate("BonDeTravail", "Req. Pièces"))
        self.checkBoxFormation.setText(_translate("BonDeTravail", "Aide extérieure"))

...
"}")
        ...
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap("../Images/plus.png"))
        ...
        spacerItem3 = QtWidgets.QSpacerItem(400, 20, QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Minimum)

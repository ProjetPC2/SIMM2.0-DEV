...
class Ui_ConsultationEquipement(object):
    def setupUi(self, ConsultationEquipement):
        ...
        self.labelTitreId = QtWidgets.QLabel(ConsultationEquipement)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.labelTitreId.setFont(font)
        self.labelTitreId.setStyleSheet("background:white;")
        self.labelTitreId.setAlignment(QtCore.Qt.AlignRight | QtCore.Qt.AlignTrailing | QtCore.Qt.AlignVCenter)
        self.labelTitreId.setObjectName("labelTitreId")
        self.verticalLayout.addWidget(self.labelTitreId)
        ...
        self.labelTitreUnite = QtWidgets.QLabel(ConsultationEquipement)
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.labelTitreFreqEntretien = QtWidgets.QLabel(ConsultationEquipement)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.labelTitreFreqEntretien.setFont(font)
        self.labelTitreFreqEntretien.setStyleSheet("background:white;")
        self.labelTitreFreqEntretien.setAlignment(QtCore.Qt.AlignRight | QtCore.Qt.AlignTrailing | QtCore.Qt.AlignVCenter)
        ...
        self.labelTitreEtatDeService.setAlignment(
        ...
        self.labelTitreVoltage = QtWidgets.QLabel(ConsultationEquipement)
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.labelUnite = QtWidgets.QLabel(ConsultationEquipement)
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.labelFreqEntretien = QtWidgets.QLabel(ConsultationEquipement)
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.labelVoltage = QtWidgets.QLabel(ConsultationEquipement)
        font = QtGui.QFont()
        font.setPointSize(10)
...
"")
    ...
    def retranslateUi(self, ConsultationEquipement):
        ...
        self.labelTitreId.setText(_translate("ConsultationEquipement", "ID : "))
        ...
        self.labelTitreUnite.setText(_translate("ConsultationEquipement", "Unité : "))
        ...
        self.labelTitreFreqEntretien.setText(_translate("ConsultationEquipement", "Fréquence d\'entretien (jours) : "))
        ...
        self.labelTitreVoltage.setText(_translate("ConsultationEquipement", "Voltage/Courant :"))
        ...
        self.labelUnite.setText(_translate("ConsultationEquipement", "Unité des soins intensifs (Néonatologie)"))
        ...
        self.labelVoltage.setText(_translate("ConsultationEquipement", "D-HSM-001"))

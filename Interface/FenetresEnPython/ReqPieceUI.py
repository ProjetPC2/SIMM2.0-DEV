...
class Ui_ReqPiece(object):
    def setupUi(self, ReqPiece):
        ...
        ReqPiece.resize(1238, 601)
        self.valider_pushButton = QtWidgets.QPushButton(ReqPiece)
        self.valider_pushButton.setGeometry(QtCore.QRect(790, 530, 191, 51))
        font = QtGui.QFont()
        ...
        self.annuler_pushButton.setGeometry(QtCore.QRect(1000, 530, 191, 51))
        font = QtGui.QFont()
        font.setPointSize(11)
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(20, 100, 179, 341))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(200, 100, 201, 341))
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        ...
        self.function_title_label.setGeometry(QtCore.QRect(20, 10, 371, 51))
        font = QtGui.QFont()
        ...
        self.enregistrer_pdf_checkBox.setGeometry(QtCore.QRect(790, 490, 171, 23))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.envoyer_courriel_checkbox.setGeometry(QtCore.QRect(1000, 490, 181, 23))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.equipement_title_label.setGeometry(QtCore.QRect(20, 60, 131, 31))
        font = QtGui.QFont()
        ...
        self.piece_associee_title_label.setGeometry(QtCore.QRect(420, 60, 181, 31))
        font = QtGui.QFont()
        font.setPointSize(15)
        font.setUnderline(True)
        ...
        self.verticalLayoutWidget_3.setGeometry(QtCore.QRect(420, 100, 160, 141))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.verticalLayoutWidget_4.setGeometry(QtCore.QRect(580, 100, 191, 141))
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        ...
        self.desc_situation_title_label.setGeometry(QtCore.QRect(421, 280, 221, 17))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.desc_intervention_title_label.setGeometry(QtCore.QRect(421, 440, 231, 17))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.verticalLayoutWidget_5.setGeometry(QtCore.QRect(420, 300, 351, 131))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.verticalLayoutWidget_6.setGeometry(QtCore.QRect(420, 460, 351, 131))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.photo_piece_title_label.setGeometry(QtCore.QRect(790, 70, 131, 17))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.parcourir_pushButton.setGeometry(QtCore.QRect(930, 70, 151, 25))
        self.parcourir_pushButton.setObjectName("parcourir_pushButton")
        self.gridLayoutWidget = QtWidgets.QWidget(ReqPiece)
        self.gridLayoutWidget.setGeometry(QtCore.QRect(790, 100, 431, 381))
        self.gridLayoutWidget.setObjectName("gridLayoutWidget")
        self.gridLayout = QtWidgets.QGridLayout(self.gridLayoutWidget)
        self.gridLayout.setContentsMargins(0, 0, 0, 0)
        self.gridLayout.setObjectName("gridLayout")
        self.manuel_entretien_checkBox = QtWidgets.QCheckBox(ReqPiece)
        self.manuel_entretien_checkBox.setGeometry(QtCore.QRect(20, 460, 161, 20))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.manuel_entretien_checkBox.setFont(font)
        self.manuel_entretien_checkBox.setObjectName("manuel_entretien_checkBox")
        self.pages_manuel_label = QtWidgets.QLabel(ReqPiece)
        self.pages_manuel_label.setGeometry(QtCore.QRect(20, 500, 301, 21))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.pages_manuel_label.setFont(font)
        self.pages_manuel_label.setObjectName("pages_manuel_label")
        self.pages_manuel_lineEdit = QtWidgets.QLineEdit(ReqPiece)
        self.pages_manuel_lineEdit.setGeometry(QtCore.QRect(320, 500, 70, 22))
        self.pages_manuel_lineEdit.setObjectName("pages_manuel_lineEdit")
        self.pages_manuel_lineEdit.setEnabled(False)
        self.separation_line_1 = QtWidgets.QFrame(ReqPiece)
        self.separation_line_1.setGeometry(QtCore.QRect(400, 60, 20, 521))
        self.separation_line_1.setFrameShape(QtWidgets.QFrame.VLine)
        self.separation_line_1.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.separation_line_1.setObjectName("separation_line_1")
        self.separation_line_2 = QtWidgets.QFrame(ReqPiece)
        self.separation_line_2.setGeometry(QtCore.QRect(770, 60, 20, 521))
        self.separation_line_2.setFrameShape(QtWidgets.QFrame.VLine)
        self.separation_line_2.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.separation_line_2.setObjectName("separation_line_2")
    ...
    def retranslateUi(self, ReqPiece):
        ...
        self.photo_piece_title_label.setText(_translate("ReqPiece", "Photo(s) de la pièce:"))
        self.parcourir_pushButton.setText(_translate("ReqPiece", "Parcourir"))
        self.manuel_entretien_checkBox.setText(_translate("ReqPiece", "Manuel d\'entretien"))
        self.pages_manuel_label.setText(_translate("ReqPiece", "Pages du manuel pertinentes à la réparation: "))

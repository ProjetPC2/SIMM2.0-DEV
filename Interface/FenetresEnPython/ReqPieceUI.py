...
class Ui_ReqPiece(object):
    def setupUi(self, ReqPiece):
        ...
        self.function_title_label.setGeometry(QtCore.QRect(30, 10, 371, 51))
        font = QtGui.QFont()
        ...
        self.gridLayoutWidget.setGeometry(QtCore.QRect(30, 500, 431, 381))
    ...
    def retranslateUi(self, ReqPiece):
        ...
        self.photo_piece_title_label.setText(_translate("ReqPiece", "Photos de la pièce:"))

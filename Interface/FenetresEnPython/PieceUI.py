...
"}")
        ...
        self.BoutonValider.setMinimumSize(QtCore.QSize(120, 20))
...
"}")
        ...
        spacerItem4 = QtWidgets.QSpacerItem(500, 20, QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Minimum)

...
class Ui_Piece(object):
    def setupUi(self, Piece):
        ...
        Piece.resize(width * facteur_grandissement_width, heigth * facteur_grandissement_heigth)
...
"}")
        ...
        self.BoutonEnregistrerPiece.setMinimumSize(QtCore.QSize(140, 40))
        self.BoutonEnregistrerPiece.setMaximumSize(QtCore.QSize(140, 40))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
...
"}")
        ...
        self.tableCategoriePiece.horizontalHeader().setStretchLastSection(True)
        self.gridLayout.addWidget(self.tableCategoriePiece, 7, 1, 1, 6)
        ...
        self.tableResume.horizontalHeader().setStretchLastSection(True)
        self.gridLayout.addWidget(self.tableResume, 12, 1, 1, 6)

...
"background: rgb(247,247,247);")
        ...
        self.comboBoxCentreService.setMinimumSize(QtCore.QSize(150, 20))
        self.comboBoxCentreService.setMaximumSize(QtCore.QSize(300, 20))
        font = QtGui.QFont()
        font.setPointSize(10)
...
"recherche"))
        ...
        self.LabelCentreService.setText(_translate("RechercheBonDeTravail", "Unité"))
        ...
        item.setText(_translate("RechercheBonDeTravail", "Unité"))

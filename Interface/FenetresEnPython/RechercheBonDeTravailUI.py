...
class Ui_RechercheBonDeTravail(object):
    def setupUi(self, RechercheBonDeTravail):
        ...
        RechercheBonDeTravail.resize(1304, 800)
        RechercheBonDeTravail.setMinimumSize(QtCore.QSize(0, 800))
        RechercheBonDeTravail.setMaximumSize(QtCore.QSize(11111111, 1111111))
        icon = QtGui.QIcon()
...
"}")
        ...
        self.comboBoxCategorieEquipement.setMinimumSize(QtCore.QSize(150, 0))
        self.comboBoxCategorieEquipement.setMaximumSize(QtCore.QSize(300, 500))
        font = QtGui.QFont()
        ...
        self.calendrierAvant.setMinimumSize(QtCore.QSize(150, 0))
        self.calendrierAvant.setMaximumSize(QtCore.QSize(300, 500))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.calendrierApres.setMinimumSize(QtCore.QSize(150, 0))
        self.calendrierApres.setMaximumSize(QtCore.QSize(300, 500))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.comboBoxCentreService.setMinimumSize(QtCore.QSize(150, 0))
        self.comboBoxCentreService.setMaximumSize(QtCore.QSize(300, 500))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.comboBoxCentreService.setFont(font)
        self.comboBoxCentreService.setObjectName("comboBoxCentreService")
        self.gridLayout_3.addWidget(self.comboBoxCentreService, 4, 0, 1, 1)
        ...
        self.comboBoxEtat.setMinimumSize(QtCore.QSize(150, 0))
        self.comboBoxEtat.setMaximumSize(QtCore.QSize(300, 500))
        font = QtGui.QFont()
        ...
        self.lineEditDescriptionSituation.setMinimumSize(QtCore.QSize(200, 43))
...
"background: rgb(247,247,247);")
        ...
        self.gridLayout_3.addWidget(self.LabelCentreService, 3, 0, 1, 1)

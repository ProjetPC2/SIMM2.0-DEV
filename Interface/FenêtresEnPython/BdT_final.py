...
"")
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../../../GitHub/SIMM-2.0/Fenetre avec Qt designer/Bdt/save (1).png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("../../../GitHub/SIMM-2.0/Fenetre avec Qt designer/Bdt/double-left-chevron.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("../../../GitHub/SIMM-2.0/Fenetre avec Qt designer/Bdt/angle-pointing-to-left (1).png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("../../../GitHub/SIMM-2.0/Fenetre avec Qt designer/Bdt/angle-arrow-pointing-to-right.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("../../../GitHub/SIMM-2.0/Fenetre avec Qt designer/Bdt/double-angle-pointing-to-right.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.labelEcritureBonTravail.setMaximumSize(QtCore.QSize(220, 20))
        font = QtGui.QFont()
        font.setPointSize(10)
...
"}")
        ...
        self.textEditDescSituation.setMaximumSize(QtCore.QSize(16777215, 110))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.textEditDescIntervention.setMaximumSize(QtCore.QSize(16777215, 110))
        font = QtGui.QFont()
        font.setPointSize(10)
